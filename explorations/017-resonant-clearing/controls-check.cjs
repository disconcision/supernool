...
const code=between('function beginGrip(', 'function updateGrip(')+between('function releaseGrip(', 'function chooseContact(')+between('function clearMovement(', 'function navigateHand(')+between("addEventListener('keydown',e=>",'function updateHands(');
