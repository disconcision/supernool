...
export type RockAuthoring={list:()=>Object3D[];capture:()=>RockPlacement[];apply:(rocks:RockPlacement[])=>void;refresh:()=>void;paste:(placement:RockPlacement)=>Object3D;remove:(id:string)=>void};
