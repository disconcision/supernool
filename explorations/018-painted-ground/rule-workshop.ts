...
const treatments=[{id:'formula',tag:'A / DIRECTIONAL VARIANT',title:'Formula stamps',note:'Literal, directional, compact. Best for learning a rule and reading a problem’s recipe. The small arrow is part of the stamp.'},{id:'bar',tag:'A1 / THE CLEARING DEFAULT',title:'Identity bars',note:'Equal expressions, separated by a short bar. Less vertical space, without an arrow implying a chosen direction.'},{id:'seal',tag:'B / RECOGNITION AT A GLANCE',title:'Pocket seals',note:'A two- or three-sign shorthand. More room for silhouette and color, but it needs a learned legend. Not a literal equation.'},{id:'motion',tag:'C / A GESTURE MEMORY',title:'Branch marks',note:'A mnemonic for movement, not a complete rewrite specification. A possible companion to the formulas rather than their replacement.'}];
