...
The inventory study keeps equipment and supported routes side by side, with a switch between pocket and hovering containers. Compact identity bars are its initial tile style; the scene still uses arrows to show available move directions. Branch-mark node discs mask edges behind their glyphs.
