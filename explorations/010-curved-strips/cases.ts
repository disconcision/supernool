...
export function sample(rule:string,complexity:string,mapping:string,t:number,seed=1){
 if(rule==='generated'){
 ...
 const p=pose({rule,complexity,mapping,t,anchor:'fixed',path:'orbit',height:'level',irregularity:0});return {edges:p.segments.map(e=>({a:new T.Vector3(e.a.x,e.a.y,e.a.z),b:new T.Vector3(e.b.x,e.b.y,e.b.z),r:e.r,id:'member'+e.key})),joints:p.joints};
}
