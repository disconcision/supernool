...
const arcControls=['smallRate','mediumRate','largeRate','smallSize','mediumSize','largeSize','rockShare','arcDuration'];let arcPreview:ArcPreview|undefined;
