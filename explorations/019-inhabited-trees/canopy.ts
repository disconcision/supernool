...
export function rng(seed:number){let h=seed>>>0;return ()=>{h=(Math.imul(h,1664525)+1013904223)>>>0;return h/4294967296;};}
...
export const palette:Record<string,[string,string]>={upland:['#647536','#abb762'],fresh:['#426943','#91b25a'],gold:['#837135','#c6b76a']};
...
export function material(o:Settings,map?:T.Texture){const m=new T.MeshStandardMaterial({color:'#ffffff',roughness:1,metalness:0,side:T.DoubleSide,map,alphaTest:map ? .48 : 0,alphaToCoverage:!!map,wireframe:o.wire});addWind(m);return m;}
...
export function cardsGeometry(shaped:boolean){const g=new T.PlaneGeometry(1,1,2,2),p=g.attributes.position,n=g.attributes.normal;
