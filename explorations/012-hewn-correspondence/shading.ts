...
export function feed(members:Member[],o:Options){
...
vec3 carvedNormal(vec3 p){
 ...
 for(int i=0;i<40;i++){if(i>=memberCount)break;vec4 q=memberField(p,i);float k=shape.z;
...
`;
export function carved<TM extends T.Material>(mat:TM):TM{
 ...
 mat.customProgramCacheKey=()=> 'nool-carved-v1';return mat;
}
