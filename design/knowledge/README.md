...
- [Dragology and continuous dragging](dragology.md): upstream algebra example, spatial versus temporal blending, Nool's earlier port, Supernool comparison controls, invariants and ambiguity witnesses.
