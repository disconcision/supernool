...
User correction: explicit per-grip route selection was not accepted and has been withdrawn. Discuss geometric separation, contact semantics and subtree encapsulation in the task first. The notebook is parked, not an accepted specification.
