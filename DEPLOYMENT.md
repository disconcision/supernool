# Publishing supernool

Canonical site: https://nool.ing/

The `main` branch publishes at `/`. Other source branches publish at `/<branch>/`; slashes in branch names remain slashes in the URL. `classic`, `assets`, `live`, `img`, `style`, and `explorations` are reserved top-level branch names.
