...
for(const name of ['check','associativity-check','root-base-check','encounter-sequence-check','surface-pruning-check','mesh-domain-check','problems-check','problem-reference-check']){
