...
for(const name of ['check','drag-tracking-check','derived-gestures-check','associativity-check','root-base-check','encounter-sequence-check','surface-pruning-check','mesh-domain-check','problems-check','problem-reference-check']){
