...
export default defineConfig({
 ...
 ...['index.html','symbols.html','notes.html','avatar-review.html','audio-review.html','rule-workshop.html','sigil-workshop.html'].map(p=>'explorations/018-painted-ground/'+p)
